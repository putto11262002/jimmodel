...
/**
 * Better Auth Database Schema for Drizzle ORM
 *
 * This schema defines the tables required for Better Auth with email/password authentication:
 * - user: Stores user account information
 * - session: Manages user sessions
 * - account: Stores OAuth provider connections (for future extensibility)
