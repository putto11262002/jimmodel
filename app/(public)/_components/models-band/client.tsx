...
export function ModelBandClient({ models }: FeaturedModelsProps) {
      ...
      return (
        ...
        >
          <motion.div
            ...
            viewport={{ once: true }}
            className="group relative inline-block w-20 lg:w-44 flex-shrink-0"
          >
            {/* Card Container - Compact size */}
            <div className="relative overflow-hidden rounded-lg bg-gradient-to-br from-muted to-muted/80 aspect-[4/5] transition-transform duration-300 group-hover:scale-105">
              {/* Model Image */}
              {imageUrl ? (
                <Image
                  src={imageUrl}
              ...
              {/*   <h3 className="font-heading text-white font-medium text-base whitespace-normal"> */}
              {/*     {displayName} */}
              {/*   </h3> */}
              {/*   <p className="text-white/80 text-xs uppercase tracking-[0.15em] whitespace-normal capitalize"> */}
              {/*     {model.category} */}
              {/*   </p> */}
              {/* </div> */}
              ...
              {/*   <p className="font-heading text-white font-medium text-sm whitespace-normal"> */}
              {/*     {displayName} */}
              {/*   </p> */}
              {/* </div> */}
            </div>
  ...
  return (
    <section className="relative w-full py-8 lg:py-16 bg-background overflow-hidden">
      {/* Heading */}
      {/* <motion.div */}
      {/*   initial={{ opacity: 0, y: -20 }} */}
      {/*   whileInView={{ opacity: 1, y: 0 }} */}
      ...
      {/*     Featured Talents */}
      {/*   </h2> */}
      {/*   <p className="mt-4 text-muted-foreground sm:text-xl max-w-2xl mx-auto"> */}
      {/*     Discover our exceptional models making waves in the industry */}
      {/*   </p> */}
      {/* </motion.div> */}

      <div className="mt-12 space-y-2 lg:space-y-4 relative grid">
        {/* Top Row - Scrolls Right to Left */}
        <div className="overflow-hidden whitespace-nowrap">
          <div
            ref={topRowRef}
            className="inline-flex gap-2 lg:gap-4 px-6 will-change-transform"
          >
            {/* Render three copies for seamless infinite scroll */}
            <div className="inline-flex gap-2 lg:gap-4">
              {createModelCards(topRowModels, 0, 0)}
            </div>
            <div className="inline-flex gap-2 lg:gap-4">
              {createModelCards(topRowModels, 1, 0)}
            </div>
            <div className="inline-flex gap-1 lg:gap-4">
              {createModelCards(topRowModels, 2, 0)}
            </div>
          </div>
        </div>
        ...
        <div className="relative">
          <div className="overflow-hidden whitespace-nowrap">
            ...
            >
              {/* Render three copies for seamless infinite scroll */}
              <div className="inline-flex gap-2 lg:gap-4">
                {createModelCards(bottomRowModels, 0, 1)}
              </div>
              <div className="inline-flex gap-2 lg:gap-4">
                {createModelCards(bottomRowModels, 1, 1)}
              </div>
              <div className="inline-flex gap-2 lg:gap-4">
                {createModelCards(bottomRowModels, 2, 1)}
              </div>
            </div>
          </div>
        </div>
        ...
        {/* <div className="absolute top-0 left-0 bottom-0  sm:w-[30%] bg-gradient-to-r from-20% from-background via-70% via-background/80 to-transparent pointer-events-none" /> */}
        {/* <div className="absolute top-0 right-0 bottom-0  sm:w-[30%] bg-gradient-to-l from-20% from-background via-70% via-background/80 to-transparent pointer-events-none" /> */}
      </div>
    </section>
  );
}
